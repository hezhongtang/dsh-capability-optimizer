...
export function apply(ctx, rawConfig) {
  ...
  // Proactive-consultation runtime. getDefaults reads the live layers (row
  // config ← cached settings file), so saves and resets re-shape policy and
  // anchors on the very next step without any re-wiring here.
