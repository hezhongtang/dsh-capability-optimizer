    ...
    handler: async (request, response) => {
      ...
      try {
        ...
        sendJson(response, 200, {
          ...
          topTierConsultantModels: [...TOP_TIER_CONSULTANT_MODELS],
          highIntellectRoles: [...HIGH_INTELLECT_ROLES],
          defaultTopTierConsultantModel: DEFAULT_TOP_TIER_CONSULTANT_MODEL,
