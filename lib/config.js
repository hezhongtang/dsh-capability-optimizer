...
export function normalizeConfig(raw) {
  ...
  const maxBudgetUsd = nonNegNumber(source.maxBudgetUsd, 0)
  ...
  return {
    ...
    autoConsult: source.autoConsult !== null && typeof source.autoConsult === 'object' && !Array.isArray(source.autoConsult)
      ? source.autoConsult
      : undefined,
  }
}
