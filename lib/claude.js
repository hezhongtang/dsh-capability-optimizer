 ...
 * @type {Map<string, Promise<{tools: boolean, noSessionPersistence: boolean, maxBudgetUsd: boolean, probed: boolean}>>}
 */
const capabilityCache = new Map()

/** No help text: assume nothing optional is supported. */
const NO_CAPABILITIES = Object.freeze({
  tools: false, noSessionPersistence: false, maxBudgetUsd: false, probed: false,
})
 ...
 * @returns {Promise<{tools: boolean, noSessionPersistence: boolean, maxBudgetUsd: boolean, probed: boolean}>}
 */
