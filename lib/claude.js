 ...
 * @type {Map<string, Promise<{tools: boolean, noSessionPersistence: boolean, maxBudgetUsd: boolean, settingSources: boolean, jsonSchema: boolean, probed: boolean}>>}
 */
const capabilityCache = new Map()

/** No help text: assume nothing optional is supported. */
const NO_CAPABILITIES = Object.freeze({
  tools: false, noSessionPersistence: false, maxBudgetUsd: false, settingSources: false, jsonSchema: false, probed: false,
})
...
export async function runClaudeConsult(options) {
  ...
  if (capabilities.jsonSchema) {
    args.push('--json-schema', JSON.stringify(ADVICE_ENVELOPE_SCHEMA))
