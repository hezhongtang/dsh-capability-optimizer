...
export function validateSettings(candidate) {
  ...
  if (problems.length > 0) return { ok: false, problems }
  return { ok: true, settings: { version: 2, backends: { ...v2.backends, [ACTIVE_BACKEND]: validated.settings }, autoConsult } }
}
